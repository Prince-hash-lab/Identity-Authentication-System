...
class adminCheckStudentDetails:
    def __init__(self, root):
        ...
        Left_frame.place(x=10, y=10, width=772, height=780) # width = 700
        ...
        class_Student_frame.place(x=5, y=0, width=750, height=750) #width=675

        # Enrollment no.
        rollNum_label = Label(
            class_Student_frame,
            text="Enrollment",
            font=("times new roman", 14), #15
            bg="white",
        )
        ...
        name_label.place(x=10, y=100, anchor=NW)
        ...
        name_entry.place(x=150, y=100, anchor=NW)
        ...
        year_label.place(x=10, y=170, anchor=NW)
        ...
        year_combo.place(x=150, y=170, anchor=NW)
        ...
        semester_label.place(x=10, y=240, anchor=NW)
        ...
        semester_combo.place(x=150, y=240, anchor=NW)
        ...
        dep_label.place(x=10, y=310, anchor=NW)
        ...
        dep_combo["values"] = ("Select Department", "CSE", "COE", "COBS", "EE")
        dep_combo.current(0)  # to give the bydeafault index
        dep_combo.place(x=150, y=310, anchor=NW)
        ...
        batch_label.place(x=10, y=380, anchor=NW)
        ...
        batch_combo.place(x=150, y=380, anchor=NW)
        ...
        email_label.place(x=10, y=440, anchor=NW)
        ...
        emailThapar_label.place(x=8, y=460, anchor=NW)
        ...
        email_entry.place(x=150, y=450, anchor=NW)
        ...
        phone_label.place(x=10, y=520, anchor=NW)
        ...
        phone_entry.place(x=150, y=520, anchor=NW)
        ...
        course_1_combo.place(x=550, y=30, anchor=NW)
        ...
        course_2_label.place(x=400, y=100, anchor=NW)
        ...
        course_2_combo.place(x=550, y=100, anchor=NW)
        ...
        course_3_label.place(x=400, y=170, anchor=NW)
        ...
        course_3_combo.place(x=550, y=170, anchor=NW)
        ...
        course_4_label.place(x=400, y=240, anchor=NW)
        ...
        course_4_combo.place(x=550, y=240, anchor=NW)
        ...
        gender_label.place(x=400, y=310, anchor=NW)
        ...
        gender_combo.place(x=550, y=310, anchor=NW)
        ...
        dob_label.place(x=400, y=370, anchor=NW)
        ...
        dob_label.place(x=398, y=390, anchor=NW)
        ...
        dob_entry.place(x=550, y=380, anchor=NW)
        ...
        fatherNum_label.place(x=400, y=450, anchor=NW)
        ...
        fatherNum_entry.place(x=550, y=450, anchor=NW)
        ...
        motherNum_label.place(x=400, y=520, anchor=NW)
        ...
        motherNum_entry.place(x=550, y=520, anchor=NW)

        #########################################################################

        # Button Frame
        btn_frame = Frame(class_Student_frame, bd=2, relief=RAISED, bg="black")
        btn_frame.place(x=-1, y=605, width=746, height=60)
        ...
        btn_frame1.place(x=-1, y=665, width=746, height=60)
        ...
        Right_frame.place(x=790, y=10, width=770, height=777) #x=720

        img_right = Image.open("Images/thapar2.jpeg")
        img_right = img_right.resize((740, 145), Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)
        f_lbl = Label(Right_frame, image=self.photoimg_right)
        f_lbl.place(x=10, y=5, width=740, height=145)
        ...
        Search_frame.place(x=5, y=155, width=740, height=115) # width=710
        ...
        table_frame.place(x=5, y=250, width=740, height=480)
        ...
        self.student_table.column("Enroll_no", width=150)
        ...
        self.student_table.column("Batch", width=150)
        self.student_table.column("Email", width=150)
        self.student_table.column("Phone_no", width=150)
        self.student_table.column("Father_no", width=150)

        self.student_table.column("Mother_no", width=150)
        self.student_table.column("Course1", width=150)
        self.student_table.column("Course2", width=150)
        self.student_table.column("Course3", width=150)
        self.student_table.column("Course4", width=150)
    ...
    def update_dataset(self):
        if (
            ...
            try:
                Update = messagebox.askyesno(
                    "Update",
                    "Do you want to update the student dataset",
                    parent=self.root,
                )
                if Update > 0:
                    conn = mysql.connector.connect(
