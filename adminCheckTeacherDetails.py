...
class adminCheckTeacherDetails:
    def __init__(self, root):
        ...
        Left_frame.place(x=10, y=10, width=770, height=777) # width=772, height=780)

        img_left = Image.open("Images/db2.png")
        img_left = img_left.resize((747, 242), Image.ANTIALIAS) # resize((680, 257)
        self.photoimg_left = ImageTk.PhotoImage(img_left)
        f_lbl = Label(Left_frame, image=self.photoimg_left)
        f_lbl.place(x=5, y=3, width=747, height=242)
        ...
        teacher_frame.place(x=5, y=250, width=750, height=480) # width=680, y=257

        # teacher ID
        teacherID_label = Label(
            teacher_frame,
            text="Teacher ID",
            font=("times new roman", 15), # 17
            bg="white",
        )
        teacherID_label.place(x=10, y=40, anchor=NW) 
        ...
        teacherID_entry.place(x=170, y=40, anchor=NW)
        ...
        name_label.place(x=10, y=125, anchor=NW)
        ...
        name_entry.place(x=170, y=125, anchor=NW)
        ...
        phone_label.place(x=10, y=210, anchor=NW)
        ...
        phone_entry.place(x=170, y=210, anchor=NW)
        ...
        email_label.place(x=10, y=295, anchor=NW)
        ...
        email_entry.place(x=170, y=295, anchor=NW)
        ...
        course_1_combo.place(x=550, y=40, anchor=NW)
        ...
        course_2_label.place(x=420, y=125, anchor=NW)
        ...
        course_2_combo.place(x=550, y=125, anchor=NW)
        ...
        course_3_label.place(x=420, y=210, anchor=NW)
        ...
        course_3_combo.place(x=550, y=210, anchor=NW)
        ...
        gender_label.place(x=420, y=295, anchor=NW)
        ...
        gender_combo.place(x=550, y=295, anchor=NW)

        #########################################################################

        # Button Frame
        btn_frame1 = Frame(teacher_frame, bd=2, relief=RAISED, bg="black")
        btn_frame1.place(x=-1, y=370, width=746, height=61) # y=361

        btn_frame2= Frame(teacher_frame, bd=2, relief=RAISED, bg="black")
        btn_frame2.place(x=-1, y=422, width=746, height=61)
        ...
        img_right = img_right.resize((740, 145), Image.ANTIALIAS) # (740, 130)
        self.photoimg_right = ImageTk.PhotoImage(img_right)
        f_lbl = Label(Right_frame, image=self.photoimg_right)
        f_lbl.place(x=10, y=5, width=740, height=145) # height=130
        ...
        Search_frame.place(x=5, y=155, width=740, height=115)
        ...
        table_frame.place(x=5, y=250, width=740, height=480) # width=710,
    ...
    def add_data(self):
        if (
            ...
            try:
                ...
                my_cursor.execute(
                    "insert into student_table values(%s,%s,%s,%s,%s,%s,%s,%s)",
                    (
                        self.var_id.get(),
                        self.var_name.get(),
                        self.var_phone.get(),
        ...
        if (
            ...
            try:
                Update = messagebox.askyesno(
                    "Update",
                    "Do you want to update the teacher details",
                    parent=self.root,
                )
                if Update > 0:
                    conn = mysql.connector.connect(
                    ...
                    if not Update:
                        return
                messagebox.showinfo(
                    "Success", "Teacher details successfully updated", parent=self.root
                )
            except Exception as es:
                messagebox.showerror("Error", f"Due To: {str(es)}", parent=self.root)
    ...
    def delete_data(self):
        if self.var_id.get() == "":
            messagebox.showerror(
                "Error", "Teacher ID must be required", parent=self.root
            )
        else:
            try:
                ...
                if delete > 0:
                    ...
                    messagebox.showinfo(
                        "Delete",
                        "Successfully deleted teacher details",
                        parent=self.root,
                    )
            except Exception as es:
                messagebox.showerror("Error", f"Due To: {str(es)}", parent=self.root)
