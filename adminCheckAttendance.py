...
class adminCheckAttendance:
    def __init__(self, root):
        ...
        title_lbl.place(x=545, y=170, width=540, height=55)

        # adminCheckAttendance frame
        attendance_frame = Frame(bg_img, bd=2, bg="white", highlightthickness=5)
        attendance_frame.place(x=545, y=230, width=540, height=270)
        ...
        year_label.place(x=50, y=40, anchor=NW)
        ...
        year_combo.place(x=275, y=40, anchor=NW)
        ...
        semester_label.place(x=50, y=90, anchor=NW)
        ...
        semester_combo.place(x=275, y=90, anchor=NW)
        ...
        batch_label.place(x=50, y=140, anchor=NW)
        ...
        batch_combo.place(x=275, y=140, anchor=NW)
        ...
        course_label.place(x=50, y=190, anchor=NW)
        ...
        course_combo.place(x=275, y=190, anchor=NW)
